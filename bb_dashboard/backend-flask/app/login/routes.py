...
from app.login.util import verify_pass
...
## Login & Registration
# @blueprint.route('/tushar', methods=['GET'])
# def tushar():
...
def register():
    ...
    create_account_form = CreateAccountForm(request.form, csrf_enabled=False)
    if 'register' in request.form:
        ...
        if secret_key is not None and secret_key != "ebionicsbrinkbionics":
            return render_template( 'accounts/register.html', msg='Incorrect Secret Key', success=False, form=create_account_form)
